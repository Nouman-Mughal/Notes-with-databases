// What we've built so far is a user data model, with a REST API wrapping that model to
// create our authentication information service.
...
export async function create(username, password,
    ...
    //.auth is used to setup required auth token.
    return res.body;
    }
